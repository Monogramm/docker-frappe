...
-   13.5.1-buster 13.5-buster 13-buster buster  (`images/13-master/buster/Dockerfile`)
-   13.5.1-slim-buster 13.5-slim-buster 13-slim-buster slim-buster  (`images/13-master/slim-buster/Dockerfile`)
-   13.5.1-alpine 13.5-alpine 13-alpine alpine 13.5.1 13.5 13 latest  (`images/13-master/alpine/Dockerfile`)
-   12.19.0-buster 12.19-buster 12-buster  (`images/12-master/buster/Dockerfile`)
-   12.19.0-slim-buster 12.19-slim-buster 12-slim-buster  (`images/12-master/slim-buster/Dockerfile`)
-   12.19.0-alpine 12.19-alpine 12-alpine 12.19.0 12.19 12  (`images/12-master/alpine/Dockerfile`)
